...
import '../Bookings/homeCleaning.css';

export function Booking(){
    function handleHomeCleaning(event){
        ...
        if (date === ''){
            ...
            axios.post("http://localhost:7000/HomeCleaning", userDetail)
            .then((res)=>{
    ...
    return(
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-12">
                ...
                <form onSubmit={handleHomeCleaning} className="pt-5">
                    <h1 className="text-center mt-5 pt-5 details">BOOKING DETAILS</h1>
                        <label for="workName">Work Name</label>
                        <input type="text" class="form-control" id="work_name" placeholder="Enter Work Name"  value="HOME CLEANING" readonly></input>
